...
namespace MobilityMatters.Northwind
{
    ...
    public class MailComposeRequest : ServiceRequest
    {
        ...
        [DisplayName("Message"), MailContentEditor(Rows = 10), DefaultValue("<html><body style=\"font-family: Arial, Helvetica, sans-serif; font-size: 14px;\">" +
            "<b>The following trip has been scheduled:</b><br><br><b>To confirm, you will be prompted to log-in. Log-in with username: confirm password: c0nf1rm!<br><br><b>To confirm your trip, please click the following link:</b> {ConfirmUrl}<br><b>Ride Number:</b> {RideNumber}<br><b>Appointment Date:</b> {AppointmentDate}<br><b>Client Name:</b> {ClientName}<br>" +
