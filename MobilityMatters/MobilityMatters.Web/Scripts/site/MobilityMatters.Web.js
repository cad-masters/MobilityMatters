        ...
        var EmployeesForm = /** @class */ (function (_super) {
            ...
            function EmployeesForm(prefix) {
                ...
                if (!EmployeesForm.init) {
                    ...
                    var w2 = s.BooleanEditor;
                    var w3 = s.EmailEditor;
                    var w4 = MobilityMatters.Helpers.HardcodedValuesCOVIDEditor;
                    var w5 = s.DateEditor;
...
(function (MobilityMatters) {
    ...
    (function (Northwind) {
        ...
        (function (OrderRow) {
            ...
            OrderRow.deletePermission = 'Northwind:Orders:Modify';
            OrderRow.insertPermission = 'Northwind:Orders:Modify';
            OrderRow.readPermission = 'Northwind:General';
            OrderRow.updatePermission = 'Northwind:Orders:Modify';
...
(function (MobilityMatters) {
    var Northwind;
    (function (Northwind) {
        var ProgramForm = /** @class */ (function (_super) {
            __extends(ProgramForm, _super);
            function ProgramForm(prefix) {
                var _this = _super.call(this, prefix) || this;
                if (!ProgramForm.init) {
            ...
            ProgramForm.formKey = 'Northwind.Program';
            return ProgramForm;
        }(Serenity.PrefixedContext));
        Northwind.ProgramForm = ProgramForm;
    })(Northwind = MobilityMatters.Northwind || (MobilityMatters.Northwind = {}));
})(MobilityMatters || (MobilityMatters = {}));
var MobilityMatters;
(function (MobilityMatters) {
    var Northwind;
    (function (Northwind) {
        var ProgramMultipleForm = /** @class */ (function (_super) {
            __extends(ProgramMultipleForm, _super);
            function ProgramMultipleForm(prefix) {
                var _this = _super.call(this, prefix) || this;
            ...
            ProgramMultipleForm.formKey = 'Northwind.ProgramMultiple';
            return ProgramMultipleForm;
        }(Serenity.PrefixedContext));
        Northwind.ProgramMultipleForm = ProgramMultipleForm;
    })(Northwind = MobilityMatters.Northwind || (MobilityMatters.Northwind = {}));
})(MobilityMatters || (MobilityMatters = {}));
var MobilityMatters;
(function (MobilityMatters) {
    var Northwind;
    (function (Northwind) {
        var ProgramMultipleRow;
        (function (ProgramMultipleRow) {
            ProgramMultipleRow.idProperty = 'ProgramMultipleId';
            ProgramMultipleRow.localTextPrefix = 'Northwind.ProgramMultiple';
            ProgramMultipleRow.deletePermission = 'Administration:General';
            ProgramMultipleRow.insertPermission = 'Administration:General';
            ProgramMultipleRow.readPermission = 'Administration:General';
            ProgramMultipleRow.updatePermission = 'Administration:General';
        })(ProgramMultipleRow = Northwind.ProgramMultipleRow || (Northwind.ProgramMultipleRow = {}));
    })(Northwind = MobilityMatters.Northwind || (MobilityMatters.Northwind = {}));
})(MobilityMatters || (MobilityMatters = {}));
var MobilityMatters;
(function (MobilityMatters) {
    var Northwind;
    (function (Northwind) {
        var ProgramMultipleService;
        (function (ProgramMultipleService) {
            ProgramMultipleService.baseUrl = 'Northwind/ProgramMultiple';
            [
                'Create',
                'Update',
                'Delete',
                ...
                ProgramMultipleService[x] = function (r, s, o) {
                    return Q.serviceRequest(ProgramMultipleService.baseUrl + '/' + x, r, s, o);
                };
            });
        })(ProgramMultipleService = Northwind.ProgramMultipleService || (Northwind.ProgramMultipleService = {}));
    })(Northwind = MobilityMatters.Northwind || (MobilityMatters.Northwind = {}));
})(MobilityMatters || (MobilityMatters = {}));
var MobilityMatters;
(function (MobilityMatters) {
    ...
    (function (Northwind) {
        var ProgramRow;
        (function (ProgramRow) {
            ProgramRow.idProperty = 'ProgramId';
            ProgramRow.nameProperty = 'Name';
            ProgramRow.localTextPrefix = 'Northwind.Program';
            ProgramRow.lookupKey = 'Northwind.Program';
            function getLookup() {
                return Q.getLookup('Northwind.Program');
            }
            ProgramRow.getLookup = getLookup;
            ProgramRow.deletePermission = 'Administration:General';
            ProgramRow.insertPermission = 'Administration:General';
            ProgramRow.readPermission = 'Administration:General';
            ProgramRow.updatePermission = 'Administration:General';
        })(ProgramRow = Northwind.ProgramRow || (Northwind.ProgramRow = {}));
    })(Northwind = MobilityMatters.Northwind || (MobilityMatters.Northwind = {}));
})(MobilityMatters || (MobilityMatters = {}));
var MobilityMatters;
(function (MobilityMatters) {
    ...
    (function (Northwind) {
        ...
        (function (ProgramService) {
            ProgramService.baseUrl = 'Northwind/Program';
            [
                'Create',
                'Update',
                'Delete',
                ...
                ProgramService[x] = function (r, s, o) {
                    return Q.serviceRequest(ProgramService.baseUrl + '/' + x, r, s, o);
                };
            });
        })(ProgramService = Northwind.ProgramService || (Northwind.ProgramService = {}));
    })(Northwind = MobilityMatters.Northwind || (MobilityMatters.Northwind = {}));
})(MobilityMatters || (MobilityMatters = {}));
var MobilityMatters;
(function (MobilityMatters) {
    ...
    (function (Northwind) {
        var OrderGrid = /** @class */ (function (_super) {
            ...
            OrderGrid.prototype.getColumns = function () {
                ...
                Q.first(columns, function (x) { return x.field == "ConfirmRide" /* ConfirmRide */; }).cssClass += " col-unit-price";
                return columns;
            };
            /**
             ...
             */
            OrderGrid.prototype.getItemCssClass = function (item, index) {
                var klass = "";
...
(function (MobilityMatters) {
    var Northwind;
    (function (Northwind) {
        var ProgramListFormatter = /** @class */ (function () {
            function ProgramListFormatter() {
            }
            ProgramListFormatter.prototype.format = function (ctx) {
                var idList = ctx.value;
                if (!idList || !idList.length)
                    return "";
                var byId = Northwind.ProgramRow.getLookup().itemById;
            ...
            ProgramListFormatter = __decorate([
                Serenity.Decorators.registerFormatter()
            ], ProgramListFormatter);
            return ProgramListFormatter;
        }());
        Northwind.ProgramListFormatter = ProgramListFormatter;
    })(Northwind = MobilityMatters.Northwind || (MobilityMatters.Northwind = {}));
})(MobilityMatters || (MobilityMatters = {}));
var MobilityMatters;
(function (MobilityMatters) {
...
(function (MobilityMatters) {
    ...
    (function (Northwind) {
        ...
        Northwind.CurrencyFormatter = CurrencyFormatter;
    })(Northwind = MobilityMatters.Northwind || (MobilityMatters.Northwind = {}));
})(MobilityMatters || (MobilityMatters = {}));
var MobilityMatters;
(function (MobilityMatters) {
...
(function (MobilityMatters) {
    var Northwind;
    (function (Northwind) {
        var ProgramDialog = /** @class */ (function (_super) {
            __extends(ProgramDialog, _super);
            function ProgramDialog() {
                var _this = _super !== null && _super.apply(this, arguments) || this;
                _this.form = new Northwind.ProgramForm(_this.idPrefix);
                return _this;
            }
            ProgramDialog.prototype.getFormKey = function () { return Northwind.ProgramForm.formKey; };
            ProgramDialog.prototype.getIdProperty = function () { return Northwind.ProgramRow.idProperty; };
            ProgramDialog.prototype.getLocalTextPrefix = function () { return Northwind.ProgramRow.localTextPrefix; };
            ProgramDialog.prototype.getNameProperty = function () { return Northwind.ProgramRow.nameProperty; };
            ProgramDialog.prototype.getService = function () { return Northwind.ProgramService.baseUrl; };
            ProgramDialog = __decorate([
                Serenity.Decorators.registerClass()
            ], ProgramDialog);
            return ProgramDialog;
        }(Serenity.EntityDialog));
        Northwind.ProgramDialog = ProgramDialog;
    })(Northwind = MobilityMatters.Northwind || (MobilityMatters.Northwind = {}));
})(MobilityMatters || (MobilityMatters = {}));
var MobilityMatters;
(function (MobilityMatters) {
    var Northwind;
    (function (Northwind) {
        var ProgramGrid = /** @class */ (function (_super) {
            __extends(ProgramGrid, _super);
            function ProgramGrid(container) {
                return _super.call(this, container) || this;
            }
            ProgramGrid.prototype.getColumnsKey = function () { return 'Northwind.Program'; };
            ProgramGrid.prototype.getDialogType = function () { return Northwind.ProgramDialog; };
            ProgramGrid.prototype.getIdProperty = function () { return Northwind.ProgramRow.idProperty; };
            ProgramGrid.prototype.getLocalTextPrefix = function () { return Northwind.ProgramRow.localTextPrefix; };
            ProgramGrid.prototype.getService = function () { return Northwind.ProgramService.baseUrl; };
            ProgramGrid = __decorate([
                Serenity.Decorators.registerClass()
            ], ProgramGrid);
            return ProgramGrid;
        }(Serenity.EntityGrid));
        Northwind.ProgramGrid = ProgramGrid;
    })(Northwind = MobilityMatters.Northwind || (MobilityMatters.Northwind = {}));
})(MobilityMatters || (MobilityMatters = {}));
var MobilityMatters;
(function (MobilityMatters) {
    var Northwind;
    (function (Northwind) {
        var ProgramMultipleDialog = /** @class */ (function (_super) {
            __extends(ProgramMultipleDialog, _super);
            function ProgramMultipleDialog() {
                var _this = _super !== null && _super.apply(this, arguments) || this;
                _this.form = new Northwind.ProgramMultipleForm(_this.idPrefix);
                return _this;
            }
            ProgramMultipleDialog.prototype.getFormKey = function () { return Northwind.ProgramMultipleForm.formKey; };
            ProgramMultipleDialog.prototype.getIdProperty = function () { return Northwind.ProgramMultipleRow.idProperty; };
            ProgramMultipleDialog.prototype.getLocalTextPrefix = function () { return Northwind.ProgramMultipleRow.localTextPrefix; };
            ProgramMultipleDialog.prototype.getService = function () { return Northwind.ProgramMultipleService.baseUrl; };
            ProgramMultipleDialog = __decorate([
                Serenity.Decorators.registerClass()
            ], ProgramMultipleDialog);
            return ProgramMultipleDialog;
        }(Serenity.EntityDialog));
        Northwind.ProgramMultipleDialog = ProgramMultipleDialog;
    })(Northwind = MobilityMatters.Northwind || (MobilityMatters.Northwind = {}));
})(MobilityMatters || (MobilityMatters = {}));
var MobilityMatters;
(function (MobilityMatters) {
    var Northwind;
    (function (Northwind) {
        var ProgramMultipleGrid = /** @class */ (function (_super) {
            __extends(ProgramMultipleGrid, _super);
            function ProgramMultipleGrid(container) {
                return _super.call(this, container) || this;
            }
            ProgramMultipleGrid.prototype.getColumnsKey = function () { return 'Northwind.ProgramMultiple'; };
            ProgramMultipleGrid.prototype.getDialogType = function () { return Northwind.ProgramMultipleDialog; };
            ProgramMultipleGrid.prototype.getIdProperty = function () { return Northwind.ProgramMultipleRow.idProperty; };
            ProgramMultipleGrid.prototype.getLocalTextPrefix = function () { return Northwind.ProgramMultipleRow.localTextPrefix; };
            ProgramMultipleGrid.prototype.getService = function () { return Northwind.ProgramMultipleService.baseUrl; };
            ProgramMultipleGrid = __decorate([
                Serenity.Decorators.registerClass()
            ], ProgramMultipleGrid);
            return ProgramMultipleGrid;
        }(Serenity.EntityGrid));
        Northwind.ProgramMultipleGrid = ProgramMultipleGrid;
    })(Northwind = MobilityMatters.Northwind || (MobilityMatters.Northwind = {}));
})(MobilityMatters || (MobilityMatters = {}));
var MobilityMatters;
(function (MobilityMatters) {
