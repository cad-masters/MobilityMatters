    ...
    (function (Northwind) {
        var CustomerDialog = /** @class */ (function (_super) {
            ...
            CustomerDialog.prototype.loadEntity = function (entity) {
                ...
                if (!this.isNew()) {
                    Northwind.OrderService.List({
                        EqualityFilter: {
                            CustomerID: this.entity.CustomerID
                        },
                        Sort: ["OrderDate" /* OrderDate */ + " desc"]
                    }, function (response) {
                        if (response.Entities.length) {
                            _this.form.DateOfLastTrip.value = response.Entities[0].OrderDate;
                        }
                    }, {
                        async: false
                    });
    ...
    (function (Northwind) {
        var EmployeesGrid = /** @class */ (function (_super) {
            ...
            EmployeesGrid.prototype.onViewSubmit = function () {
                ...
                var request = this.view.params;
                request.EqualityFilter = request.EqualityFilter || {};
                request.EqualityFilter["OnVacation" /* OnVacation */] = false;
                return true;
            };
